...
public class RestOpenApiDefaultProducesConsumesTest {
    ...
    public void testDefaultConsumesConfig(String openApiVersion) throws Exception {
    ...
    @ParameterizedTest
    @ValueSource(strings = { "3.0", "2.0" })
    public void testDefaultProducesConfig(String openApiVersion) throws Exception {
        CamelContext context = new DefaultCamelContext();
        context.addRoutes(new RouteBuilder() {
            @Override
            public void configure() {
    ...
    @ParameterizedTest
    @ValueSource(strings = { "3.0", "2.0" })
    public void testDefaultConfigMediaType(String openApiVersion) throws Exception {
        CamelContext context = new DefaultCamelContext();
        context.addRoutes(new RouteBuilder() {
            @Override
            public void configure() {
        ...
        if (openApiVersion.equals("3.0")) {
            ...
            assertConsumesMatches(requestBody, openApiVersion, "application/json");

            JsonNode responses = root.findValue("responses");
            assertProducesMatches(responses, openApiVersion, "application/json");
        } else {
            assertConsumesMatches(root, openApiVersion, "application/json");
            assertProducesMatches(root, openApiVersion, "application/json");
        }
    }

    @ParameterizedTest
    @ValueSource(strings = { "3.0", "2.0" })
    public void testVerbConfigOverridesDefaultConfig(String openApiVersion) throws Exception {
        CamelContext context = new DefaultCamelContext();
        context.addRoutes(new RouteBuilder() {
            @Override
            public void configure() {
    ...
    @ParameterizedTest
    @ValueSource(strings = { "3.0", "2.0" })
    public void testGlobalConfigOverridesDefaultConfig(String openApiVersion) throws Exception {
        CamelContext context = new DefaultCamelContext();
        context.addRoutes(new RouteBuilder() {
            @Override
            public void configure() {
